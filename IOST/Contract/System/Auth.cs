...
namespace IOSTSdk.Contract.System
{
    ...
    public static class Auth
    {
        ...
        public static Transaction AuthAddPermission(this Transaction tx, string username, string permissionName, double permissionThreshold)
        {
        ...
        public static Transaction AuthAssignPermission(this Transaction tx, string username, string permissions, string item, double weight)
        {
        ...
        /// <param name="item"></param>
        /// <param name="weight"></param>
        public static Transaction AuthAssignGroup(this Transaction tx, string username, string groupName, string item, double weight)
        {
