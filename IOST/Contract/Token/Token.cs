// generated by IOST.DevTools last: 3/25/2019 6:12:53 AM
namespace IOSTSdk.Contract.Token
{
    ...
    public static class Token
    {
        ...
        public static Transaction TokenCreate(this Transaction tx, string tokenSym, string issuer, double totalSupply, object config)
        {
        ...
        /// <param name="memo">Additional Information</param>
        public static Transaction TokenTransferFreeze(this Transaction tx, string tokenSym, string from, string to, string amount, double ftime, string memo)
        {
