...
namespace IOSTSdk.Contract.Token
{
    ...
    public static class Token721
    {
        ...
        public static Transaction Token721Create(this Transaction tx, string tokenSym, string issuer, double totalSupply)
        {
        ...
        public static Transaction Token721TokenOfOwnerByIndex(this Transaction tx, string tokenSym, string owner, double index)
        {
